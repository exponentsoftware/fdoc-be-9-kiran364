...
db.todo.belongsToMany(db.coments, {through: 'todo_coments', foreignKey: 'todo_id', as:'todo_comments'});
db.coments.belongsToMany(db.todo, {through: "todo_coments", foreignKey: 'coment_id', as: 'todo_comments'});
